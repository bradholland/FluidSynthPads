...
build: $(BUILD_DIR)/FluidSynthPads.lv2/FluidPlug.so \
       ...
       $(BUILD_DIR)/FluidSynthPads.lv2/default-preset.ttl

# Copy static files from source LV2 bundle
$(BUILD_DIR)/FluidSynthPads.lv2/default-preset.ttl: FluidSynthPads.lv2/default-preset.ttl
...
# Download and extract soundfont
$(BUILD_DIR)/FluidSynthPads.lv2/FluidPlug.sf2:
	mkdir -p $(BUILD_DIR)/FluidSynthPads.lv2
